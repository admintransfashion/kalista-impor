	...
	public function execute($options) {
		...
		try {
			...
			$where = \FGTA4\utils\SqlUtility::BuildCriteria(
				$options->criteria,
				[
					"supvisitsite_id" => " supvisitsite_id = :supvisitsite_id "
				]
			);

			$sql = \FGTA4\utils\SqlUtility::Select('trn_supvisitsite', [
				'supvisitsite_id', 'site_id', 'supvisit_id', '_createby', '_createdate', '_modifyby', '_modifydate' 
			], $where->sql);
