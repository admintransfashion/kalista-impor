	...
	public function execute($options) {
		...
		try {
			...
			$where = \FGTA4\utils\SqlUtility::BuildCriteria(
				$options->criteria,
				[
					"supvisituser_id" => " supvisituser_id = :supvisituser_id "
				]
			);

			$sql = \FGTA4\utils\SqlUtility::Select('trn_supvisituser', [
				'supvisituser_id', 'user_id', 'supvisit_id', '_createby', '_createdate', '_modifyby', '_modifydate' 
			], $where->sql);
