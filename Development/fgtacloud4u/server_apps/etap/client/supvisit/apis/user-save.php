...
class DataSave extends WebAPI {
	...
	public function execute($data, $options) {
		$tablename = 'trn_supvisituser';
		$primarykey = 'supvisituser_id';
		...
		try {
			...
			$sql = \FGTA4\utils\SqlUtility::Select($tablename , [
				$primarykey,  'supvisituser_id', 'user_id', 'supvisit_id', '_createby', '_createdate', '_modifyby', '_modifydate', '_createby', '_createdate', '_modifyby', '_modifydate'
			], $where->sql);
