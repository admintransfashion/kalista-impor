...
class DataSave extends WebAPI {
	...
	public function execute($data, $options) {
		$tablename = 'trn_supvisitsite';
		$primarykey = 'supvisitsite_id';
		...
		try {
			...
			try {
				...
				$header_table = 'trn_supvisit';
				$header_primarykey = 'supvisit_id';
			...
			$sql = \FGTA4\utils\SqlUtility::Select($tablename , [
				$primarykey,  'supvisitsite_id', 'site_id', 'supvisit_id', '_createby', '_createdate', '_modifyby', '_modifydate', '_createby', '_createdate', '_modifyby', '_modifydate'
			], $where->sql);
