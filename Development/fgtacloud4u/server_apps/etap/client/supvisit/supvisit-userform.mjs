...
const obj = {
	txt_supvisituser_id: $('#pnl_edituserform-txt_supvisituser_id'),
	cbo_user_id: $('#pnl_edituserform-cbo_user_id'),
	txt_supvisit_id: $('#pnl_edituserform-txt_supvisit_id')
}
...
export async function init(opt) {
	...
	form = new global.fgta4form(pnl_form, {
		primary: obj.txt_supvisituser_id,
		autoid: true,
		logview: 'trn_supvisituser',
		btn_edit: btn_edit,
		btn_save: btn_save,
	...
	obj.cbo_user_id.name = 'pnl_edituserform-cbo_user_id'		
...
export function open(data, rowid, hdata) {
	...
	txt_title.html(hdata.supvisit_descr)
	header_data = hdata
...
export function createnew(hdata) {
	...
	form.createnew(async (data, options)=>{
		data.supvisit_id= hdata.supvisit_id
		data.user_value = 0
...
function form_idsetup(options) {
	var objid = obj.txt_supvisituser_id
