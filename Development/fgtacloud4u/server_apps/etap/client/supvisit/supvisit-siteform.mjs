...
const obj = {
	txt_supvisitsite_id: $('#pnl_editsiteform-txt_supvisitsite_id'),
	cbo_site_id: $('#pnl_editsiteform-cbo_site_id'),
	txt_supvisit_id: $('#pnl_editsiteform-txt_supvisit_id')
}
...
export async function init(opt) {
	...
	form = new global.fgta4form(pnl_form, {
		primary: obj.txt_supvisitsite_id,
		autoid: true,
		logview: 'trn_supvisitsite',
		btn_edit: btn_edit,
		btn_save: btn_save,
...
function form_idsetup(options) {
	var objid = obj.txt_supvisitsite_id
