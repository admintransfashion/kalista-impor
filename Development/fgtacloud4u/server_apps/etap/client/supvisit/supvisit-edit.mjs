...
const obj = {
	txt_supvisit_id: $('#pnl_edit-txt_supvisit_id'),
	txt_supvisit_descr: $('#pnl_edit-txt_supvisit_descr'),
	dt_supvisit_datestart: $('#pnl_edit-dt_supvisit_datestart'),
	dt_supvisit_dateend: $('#pnl_edit-dt_supvisit_dateend'),
	chk_supvisit_iscommit: $('#pnl_edit-chk_supvisit_iscommit'),
...
export async function init(opt) {
	...
	form = new global.fgta4form(pnl_form, {
		primary: obj.txt_supvisit_id,
		autoid: true,
		logview: 'trn_supvisit',
...
export function createnew() {
	form.createnew(async (data, options)=>{
		...
		// set nilai-nilai default untuk form
			data.supvisit_datestart = global.now()
			data.supvisit_dateend = global.now()
