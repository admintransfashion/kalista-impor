...
if (is_file(__DIR__ .'/etapsalesdata.php-handler.php')) {
	require_once __DIR__ .'/etapsalesdata.php-handler.php';
}

/**
 * etap/client/etapsalesdata/etapsalesdata.php
 *
 * ===================================================================
 * Entry point Program Module etapsalesdata
 * ===================================================================
...
$MODULE = new class extends WebModule {
	...
	public function LoadPage() {
		...
		$handlerclassname = "\\FGTA4\\module\\etapsalesdata_pageHandler";
		if (class_exists($handlerclassname)) {
			$hnd = new etapsalesdata_pageHandler();
			$hnd->caller = &$this;
			$hnd->auth = $this->auth;
