...
import * as hnd from  './etapsalesdata-edit-hnd.mjs'
...
const obj = {
	txt_etapsalesdata_id: $('#pnl_edit-txt_etapsalesdata_id'),
	txt_tx_id: $('#pnl_edit-txt_tx_id'),
	dt_tx_date: $('#pnl_edit-dt_tx_date'),
	cbo_site_id: $('#pnl_edit-cbo_site_id'),
	txt_etapsalesdata_qty: $('#pnl_edit-txt_etapsalesdata_qty'),
	txt_etapsalesdata_value: $('#pnl_edit-txt_etapsalesdata_value'),
	txt_etapsalesdata_tax: $('#pnl_edit-txt_etapsalesdata_tax')
}
...
export async function init(opt) {
	...
	form = new global.fgta4form(pnl_form, {
		primary: obj.txt_etapsalesdata_id,
		autoid: true,
		logview: 'trn_etapsalesdata',
...
export function createnew() {
	form.createnew(async (data, options)=>{
		...
		data.tx_date = global.now()
		data.etapsalesdata_qty = 0
		data.etapsalesdata_value = 0
		data.etapsalesdata_tax = 0
...
function form_idsetup(options) {
	var objid = obj.txt_etapsalesdata_id
