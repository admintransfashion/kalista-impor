...
/**
 * etap/client/etapsalesdata/apis/list.php
 *
 * ========
 * DataList
 * ========
 * Menampilkan data-data pada tabel header etapsalesdata (trn_etapsalesdata)
...
$API = new class extends etapsalesdataBase {
	...
	public function execute($options) {
		...
		try {
			...
			$criteriaValues = [
				"search" => " A.tx_id LIKE CONCAT('%', :search, '%') OR A.site_id LIKE CONCAT('%', :search, '%') "
			];
			if (is_object($hnd)) {
