...
if (is_file(__DIR__ .'/allotopup.php-handler.php')) {
	require_once __DIR__ .'/allotopup.php-handler.php';
}

/**
 * community/tfi/allotopup/allotopup.php
 *
 * ===================================================================
 * Entry point Program Module allotopup
 * ===================================================================
 ...
 * awal dibuat tanggal 13/01/2023
 * terakhir di generate tanggal 27/01/2023
 */
$MODULE = new class extends WebModule {
	...
	public function LoadPage() {
		...
		$handlerclassname = "\\FGTA4\\module\\allotopup_pageHandler";
		if (class_exists($handlerclassname)) {
			$hnd = new allotopup_pageHandler();
			$hnd->caller = &$this;
			$hnd->auth = $this->auth;
