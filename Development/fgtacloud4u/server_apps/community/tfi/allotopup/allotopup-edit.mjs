...
import * as hnd from  './allotopup-edit-hnd.mjs'
...
const obj = {
	txt_allotopup_id: $('#pnl_edit-txt_allotopup_id'),
	cbo_site_id: $('#pnl_edit-cbo_site_id'),
	dt_allotopup_date: $('#pnl_edit-dt_allotopup_date'),
	txt_allotopup_name: $('#pnl_edit-txt_allotopup_name'),
	txt_allotopup_email: $('#pnl_edit-txt_allotopup_email'),
	txt_allotopup_phone: $('#pnl_edit-txt_allotopup_phone'),
	txt_allotopup_validr: $('#pnl_edit-txt_allotopup_validr'),
	txt_allotopup_clientref: $('#pnl_edit-txt_allotopup_clientref'),
	txt_allotopup_txid: $('#pnl_edit-txt_allotopup_txid'),
	txt_allotopup_nonce: $('#pnl_edit-txt_allotopup_nonce'),
	txt_allotopup_timestamp: $('#pnl_edit-txt_allotopup_timestamp'),
	txt_allotopup_barcode: $('#pnl_edit-txt_allotopup_barcode'),
	txt_allotopup_alloref: $('#pnl_edit-txt_allotopup_alloref'),
	txt_allotopup_status: $('#pnl_edit-txt_allotopup_status'),
	txt_allotopup_message: $('#pnl_edit-txt_allotopup_message'),
	chk_allotopup_isdone: $('#pnl_edit-chk_allotopup_isdone'),
	chk_allotopup_isgen: $('#pnl_edit-chk_allotopup_isgen'),
	txt_allotopup_genby: $('#pnl_edit-txt_allotopup_genby'),
	txt_allotopup_gendate: $('#pnl_edit-txt_allotopup_gendate')
}
...
export async function init(opt) {
	...
	form = new global.fgta4form(pnl_form, {
		primary: obj.txt_allotopup_id,
		autoid: true,
		logview: 'trn_allotopup',
	...
	btn_generate.linkbutton({ onClick: () => { 
...
export function createnew() {
	form.createnew(async (data, options)=>{
		...
		data.allotopup_date = global.now()
		data.allotopup_validr = 0
		data.allotopup_isdone = '0'
		data.allotopup_isgen = '0'
...
function form_idsetup(options) {
	var objid = obj.txt_allotopup_id
